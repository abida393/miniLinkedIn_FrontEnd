    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (postIdStr == null || postIdStr.isEmpty()) {
                ...
                response.getWriter().write("{\"error\": \"postId is required\"}");
                return;
            }
            ...
            try {
                ...
                response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                response.getWriter().write("{\"error\": \"postId must be a valid integer\"}");
                return;
            }

            JSONObject result = ApiClient.deleteAdminPost(token, postId);
