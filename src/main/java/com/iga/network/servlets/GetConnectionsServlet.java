...
/**
 * GetConnectionsServlet: Get all accepted connections (paginated)
 * GET /api/network/connections
 */
public class GetConnectionsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            StringBuilder endpoint = new StringBuilder("/network/connections");
