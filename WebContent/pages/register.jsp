...
<%
    request.setAttribute("pageTitle", "Create Account | IGA Network");
...
<body class="bg-[#0b0e14] min-h-screen">
    ...
    <div class="hidden lg:flex w-1/2 relative bg-gradient-to-br from-[#1a237e] via-[#0d1117] to-[#0b0e14] p-12 flex-col justify-between">
        ...
        <div class="relative z-10 max-w-lg">
            <h1 class="text-4xl font-bold text-white mb-6 leading-tight">Join the Global Research Network.</h1>
            <p class="text-lg text-blue-200/70 mb-12">Connect with peers, share your findings, and collaborate on groundbreaking projects worldwide.</p>
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="glass-card p-6 border border-white/10 bg-white/5 backdrop-blur-md rounded-2xl">
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <span class="text-xs font-bold text-blue-200/50 uppercase tracking-widest">Global Members</span>
                    </div>
                ...
                <div class="glass-card p-6 border border-white/10 bg-white/5 backdrop-blur-md rounded-2xl">
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <span class="text-xs font-bold text-purple-200/50 uppercase tracking-widest">Publications</span>
                    </div>
    ...
    <div class="w-full lg:w-1/2 bg-[#0b0e14] flex flex-col items-center justify-center p-8 md:p-16 min-h-screen">
        <div class="w-full max-w-md">
            <div class="mb-10">
                <h2 class="text-3xl font-bold text-white mb-3">Create your account</h2>
                <p class="text-gray-400">Fill in the details below to join the portal.</p>
            </div>
            ...
            <form action="<%= request.getContextPath() %>/api/register" method="POST" class="space-y-6">
                <!-- Role Selection -->
                <div class="relative group">
                    <select name="role" id="role" required
                        class="w-full bg-[#161b22] border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all appearance-none cursor-pointer">
                ...
                <div class="flex items-center mt-4">
                    <label class="flex items-center text-sm text-gray-400 cursor-pointer group">
                        <input type="checkbox" required class="hidden">
                        ...
                        I agree to the <a href="#" class="text-blue-400 hover:underline ml-1">Terms of Service</a>
                    </label>
                </div>

                <!-- Register Button -->
                <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold py-4 rounded-xl transition-all shadow-xl shadow-blue-500/20 active:scale-[0.98] mt-6">
                    Create Account
                </button>
            </form>

            <div class="mt-8 text-center text-gray-400">
                Already have an account? <a href="<%= request.getContextPath() %>/pages/login.jsp" class="text-white font-bold hover:underline">Sign in</a>
            </div>
        </div>
    </div>
